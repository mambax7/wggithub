 ...
 */
function xoops_module_pre_uninstall_wggithub(\XoopsModule $module)
{
 ...
 */
function xoops_module_uninstall_wggithub(\XoopsModule $module)
{
    //    return true;
    ...
    if (\is_file($xmlfile)) {
        if (false === ($delOk = \unlink($xmlfile))) {
            $module->setErrors(\sprintf(\_AM_WGGITHUB_ERROR_BAD_REMOVE, $xmlfile));
        }
    }
